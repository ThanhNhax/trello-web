    ...
    if (activeColumn._id !== overCardId._id) {
      setOrderColumnsState((pre) => {
        ...
        if (nextOverColumn) {
          ...
          //Xóa cái card rỗng đi
          nextOverColumn.cards = nextOverColumn.cards.filter(
            (card) => !card.FE_PlanceholderCard
          )
          // Cập nhật lại mảng cardOrderIds cho chuẩn data
    ...
    if (activeDragItemType === ACTIVE_DRAG_ITEM_TYPE.CARD) {
      ...
      if (oldColumnWhenDraggingCard._id !== overColumn._id) {
        setOrderColumnsState((pre) => {
          ...
          const isBelowOverItem =
            active.rect.current.trangslated &&
            active.rect.current.trangslated.top >
        ...
        arrayMove(oldColumnWhenDraggingCard?.cards, oldCardIndex, newCardIndex)
