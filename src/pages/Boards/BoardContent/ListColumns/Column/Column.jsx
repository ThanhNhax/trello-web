...
const Column = ({ column }) => {
  ...
  const dndKitColumnStyle = {
    ...
    transition,
    //Chiều cao phải luôn max 100% vì nếu không sẽ lỗi lúc kéo column ngắn qua một cái column dài thì phải ở khu vực giữa , {..listeners} phải bắt lúc kéo thì ở Box con của Div
    height: '100%',
